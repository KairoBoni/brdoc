...
class Search extends React.Component {
  ...
  componentWillReceiveProps = () => {
    ...
    setTimeout(() => {
      ...
      if (filter) {
        let ref = firebase.firestore().collection("docs").orderBy("nota", "desc")
  ...
  componentDidMount = () => {
    ...
    ref = firebase.firestore().collection("docs").orderBy("nota", "desc");
    ref.get().then(function async(querySnapshot) {
      const docs = []
      querySnapshot.forEach(function (doc) {
        docs.push({
          CRM: doc.id,
